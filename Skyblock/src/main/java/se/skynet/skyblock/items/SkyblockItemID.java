...
import se.skynet.skyblock.items.items.admin.AdminMegalodonToothTalisman;
...
public enum SkyblockItemID {
    ...
    ADMIN_COIN_WAND(AdminCoinWand.class), ADMIN_BOOT(AdminBoot.class), ADMIN_TAILSMAN(AdminTailsman.class), ADMIN_MEGALODON_TOOTH_TAILSMAN(AdminMegalodonToothTalisman.class),
